...
import startUpEventsImg from '../../../assets/startUpEventsImg.png'
                ...
                <div className='individual-servicepage-container'>
                    <div className='individual-servicepage-leftcontainer'>
                        <div className='individual-servicepage-headcontainer'>
                            <h3 className='individual-servicepage-startupeventsheadtext'>Startup Events</h3>
                            <div className='individual-servicepage-paracontainer'>
                                <p className='individual-servicepage-paratext'>Whether it’s a launch party or a networking event, we bring your visioMake your startup 
                                    unforgettable! We specialize in organizing impactful events that leave a lasting impression on your target audience. When to life.</p>
                            </div>
                            <ul className='individual-servicepage-listcontainer'>
                                <li>Event Planning & Coordination</li>
                                <li>Brand Activations & Experiences</li>
                                <li>Audience Engagement & Promotion</li>
                    ...
                    <div className='individual-servicepage-Rightcontainer'>
                        <div className='individual-servicepage-imgcontainer'>
                            <img className='individual-servicepage-startupeventsimg' src={startUpEventsImg} alt="" />
                        </div>
                    </div>
                </div>
            </div>
